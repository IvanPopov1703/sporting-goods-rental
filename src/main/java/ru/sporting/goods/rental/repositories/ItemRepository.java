...
public interface ItemRepository extends JpaRepository<Items, Long> {
    ...
    @Query(value = "SELECT item.id_item, item.type_of_item_id, item.view_of_item_id, item.name_item, " +
            "item.number_of_copies, item.cost_one_hour_rental, type_of_item.id_type_of_item, type_of_item.name, " +
